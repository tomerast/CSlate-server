...
import { pipelines, pipelineUploads, type Pipeline, type NewPipeline, type PipelineUpload, type NewPipelineUpload } from '../schema'
...
type PipelineUpdateFields = Partial<Pick<Pipeline,
  ...
  'manifest' | 'tags' | 'description' | 'updatedAt'
>>
